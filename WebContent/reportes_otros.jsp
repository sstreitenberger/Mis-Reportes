...
<body>
	...
	<script>
		$('#_menu3').addClass('active');
	</script>
	
	<c:if test="${tienda ne null }">
		...
		<div class="row">
			<div class="col-xs-6 col-md-3 col-md-offset-3 text-center">
				<div class="input-group">
					<input type="text" class="form-control" id="from_otros" name="from"
						placeholder="Desde"><span class="input-group-addon"><span
						class="fa fa-calendar" onclick="openCal('from_otros')"
						aria-hidden="true"></span> </span>
				</div>
			</div>
			<div class="col-xs-6 col-md-3 text-center">
				<div class="input-group">
					<input type="text" class="form-control" id="to_otros" name="to"
						placeholder="Hasta"><span class="input-group-addon"><span
						class="fa fa-calendar" onclick="openCal('to_otros')"
						aria-hidden="true"></span> </span>
				</div>
			</div>
		</div>
			...
			<div class="col-xs-12 col-lg-8 col-lg-offset-2">
				<div class="row text-center" id="instrutivo">
					...
					<div class="col-xs-6">
						...
						<span class="fa fa-calendar" style="font-size: 15vw"
							aria-hidden="true"></span>
					</div>
