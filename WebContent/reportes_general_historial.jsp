...
<body>
	...
	<jsp:include page="_menuTiendas.jsp"></jsp:include>
	<jsp:include page="_navbar.jsp"></jsp:include>

	<script>
		$('#_menu2').addClass('active');
	</script>
			...
			<div class="col-xs-6 col-md-3 col-md-offset-3 text-center">
				<div class="input-group">
					<input type="text" class="form-control" id="from" name="from"
						...
						class="fa fa-calendar" onclick="openCal('from')"
			...
			<div class="col-xs-6 col-md-3 text-center">
				<div class="input-group">
					<input type="text" class="form-control" id="to" name="to"
						...
						class="fa fa-calendar" onclick="openCal('to')"
						aria-hidden="true"></span> </span>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-12 col-lg-8 col-lg-offset-2">
				<div class="row text-center" id="instrutivo">
					...
					<div class="col-xs-4 col-lg-4">
						<h3>Elija las tiendas</h3>
						<span class="fa fa-list-ul" style="font-size: 15vw"
							aria-hidden="true"></span>
					</div>
				</div>
			</div>
