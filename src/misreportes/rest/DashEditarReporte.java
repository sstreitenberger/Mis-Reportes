 ...
 */
@WebServlet("/DashEditarReporte")
public class DashEditarReporte extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			repo.setTiendas( dash.getArrayTiendasReporteDash(repo.getId()) );

			if (repo != null) {

				response.setStatus(200);
				response.getWriter().append(new Gson().toJson(repo));
